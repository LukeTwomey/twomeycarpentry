...
<head>
    ...
    <title>Twomey Interiors - About</title>
        ...
        <div class="site-wrap">
            ...
            <div class="page-content about">
                ...
                <div class="text">
                    <div class="content">
                        <h1>About Us</h1>
                        <p>Twomey Interiors was established over twenty years ago, with the aim of producing quality work over quantity.</p>
                        ...
                        <a href="contact.php" class="button">Arrange a consultation</a>
                    </div>
                </div>
